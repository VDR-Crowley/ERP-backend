...
class StoreStockTransferRequest extends FormRequest
{
    ...
    /**
     * Origem e destino não podem ser o mesmo local (Plantel->Plantel ou o
     * mesmo vendedor dos dois lados) — transferência não muda nada e mascara
     * erro de preenchimento. O front nem valida isso (só ignora o submit
     * silenciosamente); o backend rejeita explicitamente.
     */
